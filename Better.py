...
class Example(wx.Frame):
    ...
    def InitUI(self):    
        ...
        menubar = wx.MenuBar()
        topMenu={'&File':['Add a book(s)','Restart','Quite'],'&Edit':['Edit a book info','Edit a book info in bulk'],'Prefrences':[],'&View':[],'&Help':['About Better Calibre']}
        tomMenuKey=('&File','&Edit','Prefrences','&View','&Help')
...
#         self.SetAutoLayout(1)
        ...
        self.colourPnl.SetBackgroundColour(wx.NamedColor('GREY'))
